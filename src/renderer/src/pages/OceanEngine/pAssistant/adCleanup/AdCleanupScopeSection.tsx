...
import { CLEANUP_MAX_ACCOUNT_COUNT, enforceMaxAccountIdsText } from '../shared/cleanupOrgConfig'

interface AdCleanupScopeSectionProps {
...
export const AdCleanupScopeSection: React.FC<AdCleanupScopeSectionProps> = ({
  selectedOrgName,
  selectedOrgEbpId,
  accountIds,
  onAccountIdsChange,
  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="p-assistant-ad-cleanup-account-ids">指定账户列表（一行一个）*</Label>
          <Textarea
            id="p-assistant-ad-cleanup-account-ids"
            placeholder="请输入需要清理广告的账户ID，每行一个..."
            value={accountIds}
